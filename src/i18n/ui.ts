...
export const ui = {
  ...
  fr: {
    ...
    'streams.rules': 'min. {n} spectateurs',
  ...
  es: {
    ...
    'clips.rules': 'mín. {n} visualizaciones',
    ...
    'streams.rules': 'mín. {n} espectadores',
  ...
  it: {
    ...
    'clips.rules': 'min. {n} visualizzazioni',
    ...
    'streams.rules': 'min. {n} spettatori',
  ...
  de: {
    ...
    'streams.rules': 'mind. {n} Zuschauer',
    'streams.live': 'LIVE',
